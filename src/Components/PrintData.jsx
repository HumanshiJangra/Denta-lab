    ...
    <div className='container mx-auto px-5'>
        ...
        <div id='pdf-content' className='text-[#888989] px-12 main relative'>
            ...
            <div className="pt-28 grid grid-cols-2 ">
                <div className='left'>
                    <p className='font-medium'> <span className='bg-[#FFD402] h-3 w-3 mr-2 inline-block '></span>Wir bitten um Kostenvoranschlag</p>
                    <div className="box h-[200px] my-10 border-solid border-[grey] border-[2px] p-4">
                        <p>Name: {formData.surname}</p>
                        <p>Adress{formData.houseno}</p>
                        <p>Phone No.</p>
...
<p>{formData.yourmail}</p>
      ...
      <button onClick={downloadPdf  }  className="button" type="submit">
      PDF Herunterladen
        </button>
    </div>
  )
